...
const mintLocation = "cdc507b4c7bef8afc3df8392859ebb5662084d0fbeca97fc316039ce43b97fdc_o1";
...
async function upgrade() {
  ...
  run.trust(classLocation.substring(0, classLocation.length - 3));

  const OldAsdfToken = await run.load(classLocation);
